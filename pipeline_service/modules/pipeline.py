...
class GenerationPipeline:
    ...
    async def generate_gs(self, request: GenerateRequest) -> GenerateResponse:
        ...
        image_edited_4 = self.qwen_edit.edit_image(
            prompt_image=image,
            seed=request.seed,
            prompt="Show this object in side view and make sure it is fully visible. Turn background neutral solid color contrasting with an object. Delete background details. Delete watermarks. Keep object colors. Sharpen image details",
        )
        image_without_background_4 = self.rmbg.remove_background(image_edited_4)
